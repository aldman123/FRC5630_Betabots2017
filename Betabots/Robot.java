...
public class Robot extends SampleRobot {
	...
	boolean compressorOn, solonoidOn;
	...
	public Robot() {
		...
		shooterSolonoid = new Solenoid(1);
	}
	...
	public void operatorControl() {
		...
		while (isOperatorControl() && isEnabled()) {
			...
			compressorOn = stick.getRawButton(6); //The BACK Button
			solonoidOn = stick.getRawButton(7); //The START Button
			...
			shooterSolonoid.set(solonoidOn);
